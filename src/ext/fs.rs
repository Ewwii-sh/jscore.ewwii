...
#[op2]
async fn op_fs_write(#[string] path: String, #[string] content: String, append: bool) -> Result<(), CoreError> {
...
deno_core::extension!(
    ...
    ops = [
        ...
        op_fs_remove, op_fs_exists, 
        op_fs_mkdir, op_fs_readdir, 
        op_fs_stat, op_fs_copy, op_fs_move
    ]
);
